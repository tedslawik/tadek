<?php
 ...
 if ( isset($_POST['btn-signup']) ) {
  ...
  $res = mysql_query($query);
   ...
   if ($res) {
    $errTyp = "success";
    $errMSG = "Gicior, we no sie zaloguj ";
    unset($name);
    unset($email);
    unset($pass);
   } else {
 ...
 <div id="login-form">
   ...
   ?>
            ...
            <div class="form-group">
             ...
             <input type="text" name="name" class="form-control" placeholder="Wprowadz imie" maxlength="50" value="<?php echo $name ?>" />
                </div>
            ...
            <div class="form-group">
             ...
             <input type="email" name="email" class="form-control" placeholder="Wprowadz Email" maxlength="40" value="<?php echo $email ?>" />
                </div>
            ...
            <div class="form-group">
             <button type="submit" class="btn btn-block btn-primary" name="btn-signup">Zarejestruj</button>
            </div>
            ...
            <div class="form-group">
             <a href="index.php">Zaloguj sie tutaj...</a>
            </div>
